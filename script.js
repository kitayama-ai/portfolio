...
const projectsData = [
    ...
    {
        title: "AIエージェントシステム",
        description: "商品名を入れるだけで自動で月に300枚のバナー画像納品を実現するシステム。11種類のAIエージェント（コピーライター、クリエイティブディレクター、全体ディレクター、アートディレクター、薬機法監査、フィードバック担当など）が協調してバナーの完成品そのものを制作するマルチエージェント協調システム。",
        tech: ["Python", "AIエージェント", "マルチエージェント協調", "画像生成", "自動化", "11種類のエージェント"],
        github: null, // GitHubリポジトリが公開され次第追加
        demo: null
    }
];
