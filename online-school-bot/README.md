...
3. ChatworkのWebhook設定で、Webhook URLを設定: `https://your-domain.com/api/webhook/chatwork/{course_id}`
4. Webhookイベントタイプで「メッセージ作成」を選択
...
1. 既存のChatworkグループチャットにボットを追加、またはボットとDMを開始
2. 教材に関する質問を送信
3. ボットが教材内容を参照して回答
